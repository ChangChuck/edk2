...
#define KEYBOARD_COMMAND_CLEAR_OUTPUT_DATA             0xF4
#define KEYBOARD_COMMAND_RESET                         0xFF
#define KEYBOARD_COMMAND_SELECT_SCAN_CODE_SET          0xF0

#define KEYBOARD_RETURN_BAT_SUCCESS               0xAA
#define KEYBOARD_RETURN_BAT_ERROR                 0xFC
#define KEYBOARD_RETURN_ACK                       0xFA
